...
public class ImageCodeController {
    ...
    private void generateCode(HttpServletResponse response, HttpServletRequest request) throws ServletException, IOException {
        // 输出验证码图片
        /*
         * step1.绘图
         */
        ...
        //系统生成的验证存贮在session中
        session.setAttribute("syscode", number);
        System.out.println("系统生成的验证码是:"+number);
        // 在画布上绘图
